...
def cl_args(parser, show_beta=True, show_save_after_base="", show_load_from_base="",
            dbeta=0.01, show_from_scratch=False,
    ...
    Args:
        ...
        show_save_after_base: Whether option `save_after_base` should be shown.
        show_load_after_base: Whether option `load_after_base` should be shown.
    ...
    if show_save_after_base:
        agroup.add_argument('--save_after_base', type=str, default="",
                        help='If provided, the first task ' +
                             '(hence no induced forgetting) will be saved ' +
                             'to be loaded for future experiments.')
        
    if show_load_from_base:
        agroup.add_argument('--load_from_base', type=str, default="",
                        help='If set, the first task will be skipped ' +
                             'and checkpoint will be loaded')

...
def get_current_targets(task_id, hnet, prev_task_id=None):
    ...
    Args:
        ...
        prev_task_id (list or None): If None, assume that all previous task_id
            is a list(range(task_id))
    ...
    with torch.no_grad():
        if not isinstance(hnet, HyperNetInterface):
            ...
            W = hnet.forward(cond_id=prev_task_id,
